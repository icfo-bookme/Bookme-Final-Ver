            ...
            {loading ? (
                ...
                <div className="relative">
                    <Swiper
                        ...
                        navigation={{
                            nextEl: '.ship-swiper-button-next',
                            prevEl: '.ship-swiper-button-prev',
                        }}
                        resistanceRatio={0.5}
                                        ...
                                        <div className="mt-auto pt-4">
                                            <div className="flex flex-row justify-between items-center">
                                                        ...
                                                        {(() => {
                                                            ...
                                                            if (prices.length > 0) {
                                                                ...
                                                                if (validPrices.length > 0) {
                                                                    ...
                                                                    return <span className='text-sm font-medium'>Contact for Price</span>;
                                                                }
                                                            } else {
                                                                return <span className='text-sm font-medium'>Contact for Price</span>;
                                                            }
                                                ...
                                                <Link
                                                    ...
                                                    href={`/Property/${slugify(property.property_name)}/${property.property_id}`}
                                                    className="inline-block bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white font-medium py-2 px-4 rounded-md text-sm text-center transition-all duration-300 transform hover:scale-[1.03] shadow-md hover:shadow-lg flex items-center"
                                                >
                                                    Book Now
                    ...
                    {/* Navigation Buttons */}
                    <button className="ship-swiper-button-prev hidden sm:flex absolute left-0 md:-left-4 lg:-left-6 top-1/2 -translate-y-1/2 z-10 w-8 h-8 md:w-10 md:h-10 items-center justify-center bg-white rounded-full shadow-md hover:bg-gray-100 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500 border border-blue-600">
                    ...
                    <button className="ship-swiper-button-next hidden sm:flex absolute right-0 md:-right-4 lg:-right-6 top-1/2 -translate-y-1/2 z-10 w-8 h-8 md:w-10 md:h-10 items-center justify-center bg-white rounded-full shadow-md hover:bg-gray-100 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500 border border-blue-600">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20" className="w-5 h-5 md:w-6 md:h-6 text-gray-700">
                    ...
                    <div className="w-full flex justify-center mt-8 md:mt-10">
                        <Link
                            aria-label="See all Saint Martin ships"
                            href="/tour/Saint-martin-ships/3"
                            className="inline-block bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white font-medium py-3 px-8 rounded-md text-center transition-all duration-300 transform hover:scale-[1.03] shadow-md hover:shadow-lg flex items-center"
                        >
                            See All Ships
